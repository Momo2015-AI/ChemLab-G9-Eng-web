...
const u04BackfillMisconceptions = [
  ...
  },
  {
    ...
    knowledgeIds: ['filtration-adsorption-operation'],
  ...
  },
  {
    ...
    knowledgeIds: ['water-purification-methods'],
  ...
  },
  {
    ...
    knowledgeIds: ['water-resources-conservation'],
    signals: ['concept-overreach'],
    severity: 'low',
    source: 'u04 backfill audit',
  ...
  },
  {
    ...
    knowledgeIds: ['chemical-formula-meaning'],
  ...
  },
  {
    ...
    knowledgeIds: ['chemical-formula-writing'],
    signals: ['operational-error'],
    severity: 'medium',
    source: 'u04 backfill audit',
  ...
  },
  {
    ...
    knowledgeIds: ['mass-fraction-calculation'],
    signals: ['calculation-error'],
    severity: 'medium',
    source: 'u04 backfill audit',
