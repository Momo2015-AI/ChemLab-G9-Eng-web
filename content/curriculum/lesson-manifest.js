...
export const lessonManifest = {
  ...
  lessons: [
    ...
    { day: '04', sequenceNumber: 4, canonicalId: 'lesson-04-lab-safety-operations', title: '实验安全与基本操作', semester: 'upper', unitId: 'u01', status: 'ready', releaseStatus: 'ready' },
    { day: '05', sequenceNumber: 5, canonicalId: 'lesson-05-oxygen', title: '空气与氧气', semester: 'upper', unitId: 'u02', status: 'ready', releaseStatus: 'ready' }
  ]
};
