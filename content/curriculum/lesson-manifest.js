...
export const lessonManifest = {
  ...
  lessons: [
    ...
    { day: '11', sequenceNumber: 11, displayOrder: 5, canonicalId: 'lesson-06-molecules-and-atoms', title: '分子和原子', semester: 'upper', unitId: 'u03', status: 'ready', releaseStatus: 'ready' },
    ...
    { day: '07', sequenceNumber: 7, displayOrder: 7, canonicalId: 'lesson-07-water-purification', title: '水的净化', semester: 'upper', unitId: 'u04', status: 'ready', releaseStatus: 'ready' },
    { day: '08', sequenceNumber: 8, displayOrder: 8, canonicalId: 'lesson-08-water-conservation', title: '爱护水资源', semester: 'upper', unitId: 'u04', status: 'ready', releaseStatus: 'ready' },
    { day: '09', sequenceNumber: 9, displayOrder: 9, canonicalId: 'lesson-09-chemical-formula', title: '化学式与化合价（上）', semester: 'upper', unitId: 'u04', status: 'ready', releaseStatus: 'ready' },
    { day: '10', sequenceNumber: 10, displayOrder: 10, canonicalId: 'lesson-10-chemical-equation', title: '化学式与化合价（下）', semester: 'upper', unitId: 'u04', status: 'ready', releaseStatus: 'ready' },
    { day: '05', sequenceNumber: 5, displayOrder: 11, canonicalId: 'lesson-03-acid-intro', title: '酸入门：初识身边的酸', semester: 'lower', unitId: 'u10', status: 'ready', releaseStatus: 'ready' }
  ]
};
