...
export const lessonManifest = {
  ...
  lessons: [
    ...
    { day: '07', sequenceNumber: 7, displayOrder: 6, canonicalId: 'lesson-07-oxygen-preparation-comprehensive', title: '氧气制取综合：高锰酸钾法与装置对比', semester: 'upper', unitId: 'u02', status: 'ready', releaseStatus: 'ready' },
    { day: '08', sequenceNumber: 8, displayOrder: 7, canonicalId: 'lesson-08-h2o2-oxygen-preparation', title: '过氧化氢制取氧气与催化剂', semester: 'upper', unitId: 'u02', status: 'ready', releaseStatus: 'ready' },
    { day: '05', sequenceNumber: 5, displayOrder: 8, canonicalId: 'lesson-03-acid-intro', title: '酸入门：初识身边的酸', semester: 'lower', unitId: 'u10', status: 'ready', releaseStatus: 'ready' }
  ]
};
