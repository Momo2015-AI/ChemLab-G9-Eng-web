...
// Unit metadata only. Lesson-to-unit membership is derived at render time from
// the manifest `unitId` on each lesson, so the portal stays in sync with
// content/curriculum/lesson-manifest.js without duplicating the mapping.
const UPPER_UNITS = [
  { id: 'unit-01-intro-chemistry', number: '01', title: '走进化学世界', description: '物质的变化、性质与化学实验基础' },
  { id: 'unit-02-air', number: '02', title: '我们周围的空气', description: '空气组成、氧气与相关实验' },
  { id: 'unit-03-matter-structure', number: '03', title: '物质构成的奥秘', description: '分子、原子、离子与元素' },
  { id: 'unit-04-water', number: '04', title: '自然界的水', description: '水的组成、净化与爱护' },
  { id: 'unit-05-equations', number: '05', title: '化学方程式', description: '质量守恒、方程式与计算' },
  { id: 'unit-06-carbon-oxides', number: '06', title: '碳和碳的氧化物', description: '碳单质、二氧化碳与一氧化碳' },
  { id: 'unit-07-fuel', number: '07', title: '燃料及其利用', description: '燃料、能源与环境' },
];

const LOWER_UNITS = [
  { id: 'unit-08-metals', number: '08', title: '金属和金属材料', description: '金属性质、活动性与资源利用' },
  { id: 'unit-09-solutions', number: '09', title: '溶液', description: '溶解、溶液组成与浓度' },
  { id: 'unit-10-acids-bases', number: '10', title: '酸和碱', description: '酸、碱、pH与中和' },
  { id: 'unit-11-salts-fertilizers', number: '11', title: '盐 化肥', description: '常见盐、化肥与相关实验' },
